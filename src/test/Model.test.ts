...
describe('Test Model', function() {
  ...
  it('test move task group', function() {
    const model = new Model()
  ...
  it('test move task', function() {
    ...
    model.moveTask('project_id_1', 'task_id_1', 'task_group_id_2', undefined)
    ...
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 0).getTaskByIndex(0).id).equal('task_id_2')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 0).getTaskByIndex(1).id).equal('task_id_3')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(0).id).equal('task_id_1')

    model.moveTask('project_id_1', 'task_id_2', 'task_group_id_2', 'task_id_1')
    ...
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 0).getTaskByIndex(0).id).equal('task_id_3')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(0).id).equal('task_id_1')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(1).id).equal('task_id_2')

    model.moveTask('project_id_1', 'task_id_3', 'task_group_id_2', 'task_id_1')
    ...
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 0).getTaskByIndex(0)).equal(undefined)
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(0).id).equal('task_id_1')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(1).id).equal('task_id_3')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(2).id).equal('task_id_2')

    model.moveTask('project_id_1', 'task_id_3', 'task_group_id_2', 'task_id_2')
    ...
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(1).id).equal('task_id_2')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(2).id).equal('task_id_3')

    model.moveTask('project_id_1', 'task_id_3', 'task_group_id_2', undefined)
    ...
    expect(model.getTaskGroupByIndex('project_id_1', 0).getTaskByIndex(0)).equal(undefined)
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 2).getTaskByIndex(0)).equal(undefined)
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(0).id).equal('task_id_3')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(1).id).equal('task_id_1')
    // @ts-ignore
    expect(model.getTaskGroupByIndex('project_id_1', 1).getTaskByIndex(2).id).equal('task_id_2')
  })
})